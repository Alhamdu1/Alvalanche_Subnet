...
Overview
This project establishes an EVM Subnet on the Avalanche network named "Alhamdu Nufin-Allah," featuring its native token, GamersTokens (NFA). The network seamlessly integrates with MetaMask, enabling the deployment and interaction with smart contracts through the injected provider on Remix.
...
- Node.js and npm installed on your machine.
  ...
  Alhamdu Nufin-Allah
  License
  This project is licensed under the [Alhamdu Nufin-Allah] License - see the LICENSE.md file for details
